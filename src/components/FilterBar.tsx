...
export const FilterBar = ({
  ...
  return (
    <div className="bg-card border-b border-border px-6 py-4 flex flex-col gap-4">
      {/* Top Controls Row */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full gap-4 bg-muted/30 px-3 py-2 rounded-lg border border-border/50">
        <div className="flex flex-wrap items-center gap-4">
          {/* Time Picker */}
          <div className="flex items-center gap-2">
            <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider shrink-0 hidden sm:block">Time Range:</Label>
