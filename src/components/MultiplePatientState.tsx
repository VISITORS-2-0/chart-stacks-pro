...
interface MultiplePatientStateProps {
...
export function MultiplePatientState({ data, zoomLevel = 'years', onDrillDown, conceptData }: MultiplePatientStateProps) {
    const componentId = React.useId();
    const syncId = `multiplePatientState-${componentId}`;
